...
Details on the original `orchaRd` (vers. 1.0) can be found in @Nakagawa2021-ls. Orchard 2.0 functionality is decsribed in @Nakagawa2.0, but is not yet on **CRAN**. You can download the package by visiting our [GitHub](https://github.com/daniel1noble/orchaRd) page. 
